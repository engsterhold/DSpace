...
import org.dspace.storage.safstore.factory.ItemImportServiceFactory2;
...
public class ItemImportCLITool2 {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        try {
            ...
            System.out.println("ItemImportServiceFactory2 class! CLI only " + ItemImportServiceFactory2.class);
            // ItemImportServiceFactory fac = ItemImportServiceFactory.getInstance();
            ItemImportService myloader = ItemImportServiceFactory2.getInstance().getItemImportService();
