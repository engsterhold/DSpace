...
public class SAFBitStoreService implements BitStoreService {
    /**
     * log4j log
     */
    private static Logger log = org.apache.logging.log4j.LogManager.getLogger(SAFBitStoreService.class);
