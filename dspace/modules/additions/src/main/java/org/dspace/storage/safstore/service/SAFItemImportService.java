 ...
 */
public interface SAFItemImportService {
    ...
    /**
     * Given a public URL to a zip file that has the Simple Archive Format, this
     * method imports the contents to DSpace
     *
     * @param url              The public URL of the zip file
     * @param owningCollection The owning collection the items will belong to
     * @param collections      The collections the created items will be inserted
