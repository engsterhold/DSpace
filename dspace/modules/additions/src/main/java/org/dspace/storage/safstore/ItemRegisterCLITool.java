...
import org.dspace.storage.safstore.factory.SAFItemImportServiceFactory;
...
public class ItemRegisterCLITool {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        try {
            ...
            System.out.println("ItemImportServiceFactory2 class! CLI only " + SAFItemImportServiceFactory.class);
            // ItemImportServiceFactory fac = ItemImportServiceFactory.getInstance();
            SAFItemImportService myloader = SAFItemImportServiceFactory.getInstance().getSafImportService();
            // myloader = new ItemImportServiceImpl2();
            System.out.println("myloader class! CLI only " + myloader.getClass());
